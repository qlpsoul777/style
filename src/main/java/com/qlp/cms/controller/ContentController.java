...
public class ContentController {
    ...
    public String list(@PageableDefaults(10) Pageable pageable,Model model){
        ...
        Page<Content> pageInfo =  contentService.findPageByMap(map,pr);
    ...
    public String save(HttpServletRequest request,Model model,@ModelAttribute("content")Content content){
        contentService.save(content);
        return "redirect:/cms/content/list";
    }
