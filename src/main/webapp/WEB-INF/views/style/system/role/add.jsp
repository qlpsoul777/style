...
<head>
    ...
    $(function(){
        $("#editForm").validate({
            errorElement:"em",
            rules: {
            	name: {required:true,remote:'${ctx}/role/repeatRoleName'},
            	sort: "required"
            },
            messages: {
            	loginName: {required:"不能为空",remote:"角色名已存在"},
            	sort: "不能为空"
            }
        });
	...
	<div id="contentwrapper" class="contentwrapper">
		<div id="validation" class="subcontent">
			<form id="editForm" class="stdform" method="post" action="${ctx }/role/saveAdd">
			    ...
			    <p>
                	<label>描述</label>
                    <span class="field"><textarea cols="80" name="description" rows="5" class="longinput"></textarea></span> 
                </p>
                <p>
                   <label>权限:</label>
                   <div>
